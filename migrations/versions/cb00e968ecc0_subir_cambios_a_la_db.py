...
Revision ID: cb00e968ecc0
Revises: 
Create Date: 2022-09-21 11:21:39.668328
...
def upgrade() -> None:
    ...
    sa.Column('estudio', sa.String(), nullable=True),
    ...
    sa.Column('venta_producto', sa.Integer(), nullable=True),
